          ...
          <div className="rounded-3xl p-8 md:p-12 lg:p-16">
            <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="flex-shrink-0">
                <div className="w-24 h-24 bg-gradient-to-r from-[#508e27]/10 to-[#74adaf]/10 rounded-2xl flex items-center justify-center shadow-lg">
                  <Smartphone className="h-12 w-12 bg-gradient-to-r from-[#508e27] to-[#74adaf] bg-clip-text" style={{ WebkitTextFillColor: 'transparent', WebkitBackgroundClip: 'text' }} />
                </div>
              </div>
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-xl text-gray-600 mb-6">
                  Rejoignez une centaines de commerçants gabonais qui nous font confiance. 
